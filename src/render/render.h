...
struct Vect3
{
	...
	Vect3(double setX, double setY, double setZ) // show you which arguments you should pass in
		: x(setX), y(setY), z(setZ)              // this how you initialize a member of class
	{}                                           // it is empty so, there will nothing happen as will initialize a class member,
	                                             // Check Lidar.h you will see there ass soon as a class member initlized it start do some stuffs
...
struct Car
{
	...
	// units in meters
  	...
  	Car(Vect3 setPosition, Vect3 setDimensions, Color setColor, std::string setName)       // show you which arguments you should pass in
    	: position(setPosition), dimensions(setDimensions), color(setColor), name(setName) // this how you initialize a member of class
  	{}
